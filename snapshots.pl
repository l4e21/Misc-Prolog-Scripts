...
% ?- T1 = 11:Min1, T2 = 12:Min2, snap:valid_time(T1), snap:valid_time(T2), snap:time_delta(T1, 0:30, T2), E = entry(2025/3/19, T1, T2, "Buy Soybeans"), snap:valid_entry(E), label([Min1, Min2]), \+ snap:overlapping_entry(E, E2).

% ?- T1 = 9:Min1, T2 = 10:Min2, snap:valid_time(T1), snap:valid_time(T2), snap:time_delta(T1, 0:30, T2), E = entry(2025/3/19, T1, T2, "Buy Soybeans"), snap:valid_entry(E), label([Min1, Min2]), \+ snap:overlapping_entry(E, E2).
